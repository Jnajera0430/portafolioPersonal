...
export const ContactComponent = () => {
    ...
    return <section className={`${darkMode ? " ": "" }text-gray-600 body-font relative` }>
        ...
        <div className={`container px-5 py-24 mx-auto flex`}>
            <div className={`lg:w-1/3 md:w-1/2 ${darkMode ? " bg-gray-800 text-slate-400": " bg-white text-gray-600 "}   rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md`}>
                <h2 className={`${darkMode ? " text-slate-300 " :" text-gray-900 "} text-lg mb-1 font-medium title-font`}>
                    Dejame tu mensaje
                </h2>
                <p className = {`leading-relaxed mb-5 `}>
                    Enviame un breve comentario sobre: Recomendaciones, servicios y proyectos.
                </p>
